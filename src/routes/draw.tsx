...
function DrawPage() {
  ...
  const gridClass =
    cfg.gridCols === 3 ? "grid-cols-2 sm:grid-cols-3" : "grid-cols-2 sm:grid-cols-3 md:grid-cols-4";
  ...
  return (
    <div
      className={`mx-auto max-w-7xl px-6 py-4 ${completed ? "" : "h-[calc(100svh-5rem)] flex flex-col overflow-hidden"}`}
    >
      <div className="flex flex-wrap items-end justify-between gap-4 mb-4 shrink-0">
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Ziehung · {cfg.label}</h1>
      ...
      {!enoughPool && drawn === 0 && (
        <Card className="p-5 mb-6 border-destructive/40 bg-destructive/5">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Es sind nur {eligible} eligible Mitarbeitende vorhanden. Die 80%-Sperre kann
            administrativ zurückgesetzt werden.
          </p>
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Damit werden alle Mitarbeitenden in {cfg.label} wieder ziehungsberechtigt. Die
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold">
                  Lunch Lottery {cfg.label} abgeschlossen
                </h2>
